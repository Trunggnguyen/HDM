...
function changeQuanity(id,value,price)
	{
		$.ajax({
			type: "GET",		
			url: "https://acomapp.herokuapp.com/acom/api/gio-hang/changSanPhamQuanity?id="+id+"&value="+value,
...
function deleteFromCart(id)
{
	$.ajax({
		type: "GET",		
		url: "https://acomapp.herokuapp.com/acom/api/gio-hang/deleteFromCart?id="+id,
		success: function(result){
