$(document).ready(function(){
	...
	function ajaxGet(page){
		$.ajax({
			type: "GET",		
			url: "https://acomapp.herokuapp.com/acom/api/danh-muc/all" + "?page=" + page,
...
//    });
	...
	function ajaxPost(){
    	...
    	$.ajax({
			...
			url : "https://acomapp.herokuapp.com/acom/api/danh-muc/save",
    ...
    $(document).on("click",".btnCapNhatDanhMuc",function(){
		...
		var href = "https://acomapp.herokuapp.com/acom/api/danh-muc/"+danhMucId;
    ...
    function ajaxPut(){
    	...
    	$.ajax({
			...
			type : "PUT",
			contentType : "application/json",
			url : "https://acomapp.herokuapp.com/acom/api/danh-muc/update",
			data : JSON.stringify(formData),
            // dataType : 'json',
			success : function(response) {
    ...
    $(document).on("click",".btnXoaDanhMuc", function() {
		...
		if(confirmation){
		  $.ajax({
			  type : "DELETE",
			  url : "https://acomapp.herokuapp.com/acom/api/danh-muc/delete/" + danhMucId,
