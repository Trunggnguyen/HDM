$(document).ready(function() {
	...
	function ajaxGet(page){		
		...
		$.ajax({
			...
			url: "https://acomapp.herokuapp.com/acom/api/lien-he/all" + '?page=' + page,
...
//		event.preventDefault();
	...
	$(document).on('click', '.btnChiTiet', function (event){
		...
		var href = "https://acomapp.herokuapp.com/acom/api/lien-he/"+lienHeId;
	...
	function ajaxPostReply(){
    	...
    	$.ajax({
			...
			type : "POST",
			contentType : "application/json",
			url : "https://acomapp.herokuapp.com/acom/api/lien-he/reply",
