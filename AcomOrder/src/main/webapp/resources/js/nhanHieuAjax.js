$(document).ready(function(){
	...
	function ajaxGet(page){
		$.ajax({
			type: "GET",		
			url: "https://acomapp.herokuapp.com/acom/api/nhan-hieu/all?page=" + page,
	...
	function ajaxPost(){
    	...
    	$.ajax({
			...
			url : "https://acomapp.herokuapp.com/acom/api/nhan-hieu/save",
    ...
    $(document).on("click",".btnCapNhatNhanHieu",function(){
		...
		var href = "https://acomapp.herokuapp.com/acom/api/nhan-hieu/" + nhanHieuId;
    ...
    function ajaxPut(){
    	...
    	$.ajax({
			...
			type : "PUT",
			contentType : "application/json",
			url : "https://acomapp.herokuapp.com/acom/api/nhan-hieu/update",
			data : JSON.stringify(formData),
            // dataType : 'json',
			success : function(response) {
    ...
    $(document).on("click",".btnXoaNhanHieu", function() {
		...
		if(confirmation){
		  $.ajax({
			  type : "DELETE",
			  url : "https://acomapp.herokuapp.com/acom/api/nhan-hieu/delete/" + nhanHieuId,
